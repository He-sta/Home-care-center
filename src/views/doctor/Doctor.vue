    ...
    export default {
        ...
        methods:{
            ...
            getData(){
                //this.loading=true
                var data=[];
                let url =`http://47.107.189.55:8082/HomeCareCenter/worker/search?type=1`
            ...
            query(){
                this.currPage=1
                 var data=[];
                let url =`http://47.107.189.55:8082/HomeCareCenter/worker/search?name=${this.form.name}&type=1`
                axios.get(url,{}).then(res=>{
                    for (let i = 0; i < res.data.data.length; i++) {
                        //console.log(res.data.data[i].name)
                         var form = {};
            ...
            update(id){
                console.log(id)
                this.$router.push(`/doctor/DoctorUpdate/${id}`)
            },
            del(id){
                console.log(id)
            ...
            add(){
                this.$router.push('/doctor/DoctorAdd')
            },
        }
